...
final class Version20210920054727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wallet (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, balance INT NOT NULL DEFAULT 0, INDEX IDX_7C68921F9B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
